    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: var(--bg);
            color: var(--text);
            /* 1. 모바일 축소 문제 강제 해결: 가로 스크롤을 원천적으로 차단합니다. */
            overflow-x: hidden;
        }
        .container {
            width: 100%;
        ...
        .vcard { flex: 0 0 40%; scroll-snap-align: start; border-radius: var(--radius); overflow: hidden; background: var(--card); box-shadow: var(--shadow); }
...
라이브 커머스</div>
    ...
    <section id="videos">
        ...
        <div class="videos-row">
            <div class="vcard">
                <div class="video-frame"><iframe src="about:blank" allowfullscreen></iframe></div>
